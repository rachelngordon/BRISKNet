...
def main():
    ...
    job_name = "ei_36spf_smaller_enh_scale_rebin"
    config_path = '/home/rachelgordon/mri_recon/radial-breast-ddei/configs/config_diffeo_no_arr_shift_smaller_enh_scale.yaml'
    num_nodes = 1
    gpus_per_node = 4
