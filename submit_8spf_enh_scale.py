...
def main():
    ...
    job_name = "ei_diffeo_enh_scale_8spf_slice_sampling"
    config_path = "/home/rachelgordon/mri_recon/radial-breast-ddei/configs/config_sampling_8spf_enh_scale.yaml"
    num_nodes = 4
    gpus_per_node = 4
