...
python3 "$SCRIPT_DIR/simulate_kspace_grasp_var_frames.py" \
  --dro-root /net/scratch2/rachelgordon/dro_var_frames \
  --traj-method get_traj \
  --kspace-noise-std 0.05 \
  --kspace-noise-seed 1234
