...
def load_checkpoint(model, optimizer, filename):
    ...
    eval_curves = {
        ...
        "eval_raw_dc_rel_l2s": ckpt.get("eval_raw_dc_rel_l2s", []),
        "eval_raw_dc_rel_l2_lows": ckpt.get("eval_raw_dc_rel_l2_lows", []),
        "eval_raw_dc_rel_l2_mids": ckpt.get("eval_raw_dc_rel_l2_mids", []),
        "eval_raw_dc_rel_l2_highs": ckpt.get("eval_raw_dc_rel_l2_highs", []),
        ...
        "avg_grasp_raw_dc_rel_l2": ckpt.get("avg_grasp_raw_dc_rel_l2", float("nan")),
        "avg_grasp_raw_dc_rel_l2_low": ckpt.get("avg_grasp_raw_dc_rel_l2_low", float("nan")),
        "avg_grasp_raw_dc_rel_l2_mid": ckpt.get("avg_grasp_raw_dc_rel_l2_mid", float("nan")),
        "avg_grasp_raw_dc_rel_l2_high": ckpt.get("avg_grasp_raw_dc_rel_l2_high", float("nan")),
        "avg_grasp_raw_dyn_dce_mae": ckpt.get("avg_grasp_raw_dyn_dce_mae", float("nan")),
